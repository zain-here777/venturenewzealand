...
class UpgradeController extends Controller
{
    ...
    public function upgradeToVersion119()
    {
        /**
         * Add column: places.menu
         */
        Schema::table('places', function (Blueprint $table) {
            if (!Schema::hasColumn('places', 'menu')) {
                $table->longText('menu')->nullable()->after('seo_description');
                echo "Add column 'places.mennu' success!<br>";
            } else {
                echo "Column 'places.mennu' already exists<br>";
            }

            if (!Schema::hasColumn('places', 'faq')) {
                $table->longText('faq')->nullable()->after('menu');
                echo "Add column 'places.faq' success!<br>";
            } else {
                echo "Column 'places.faq' already exists<br>";
            }
        ...
        $admincp_url = route('admin_dashboard');
        $home_url = route('home');
        return "Upgrade to Golo 1.2 success! <a href='{$admincp_url}'>Back to admincp</a> or <a href='{$home_url}'>Homepage</a>";
    }
