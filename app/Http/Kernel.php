...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'usertypeOperator' => \App\Http\Middleware\UsertypeOperator::class,
        'usertypeUser' => \App\Http\Middleware\UsertypeUser::class,
        'haveMembership' => \App\Http\Middleware\HaveMembership::class,
