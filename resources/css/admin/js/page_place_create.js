                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="text" class="form-control" name="menu[${social_item}][name]" value="" placeholder="Product name">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" class="form-control" name="menu[${social_item}][price]" value="" placeholder="Product price">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="menu[${social_item}][description]" value="" placeholder="Product description">
                </div>
            </div>
            <div class="col-md-1">
