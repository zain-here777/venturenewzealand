<div class="modal fade" id="modal_add_category" tabindex="-1" role="dialog" aria-labelledby="modal_add_category" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="category_form" action="{{route('admin_category_create')}}" method="post" data-parsley-validate enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!-- <div class="row mt-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <p><strong>Parent Category:</strong></p>
                            ...
                            @if($type === \App\Models\Category::TYPE_PLACE)
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p><strong>Map / Small Icon:</strong></p>
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <div class="col-md-12">
                                        ...
                                        <img id="preview_small_icon" src="https://via.placeholder.com/100x100?text=icon" style="width:60px;height:60px;object-fit:cover;margin-bottom:10px">
                                        <input type="file" class="form-control" id="small_icon" name="small_icon">
                                    </div>
                                </div>
