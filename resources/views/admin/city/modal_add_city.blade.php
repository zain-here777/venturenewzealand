                    ...
                    <div class="row">
                        <div class="col-md-12 city_create">
                            ...
                            <div class="tab-content">
                                @foreach($languages as $index => $language)
                                    <div class="tab-pane fade show {{$index !== 0 ?: "active"}}" id="language_{{$language->code}}" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="form-group">
                                            <label for="city_name">District name
                            ...
                            <div class="row city_image">
                                <div class="col-md-4">
                                    <p><strong>Map image-Hero:</strong></p>
                                    <img id="preview_map" src="https://via.placeholder.com/120x150?text=thumbnail" alt="city map">
                                    <input type="file" class="form-control" id="city_map" name="map" accept="image/*">
                                </div>
                                <div class="col-md-4">
                                    <p><strong>Map image-Tile:</strong></p>
                                    <img id="preview_map_tile" src="https://via.placeholder.com/120x150?text=thumbnail" alt="city map_tile">
                                    <input type="file" class="form-control" id="city_map_tile" name="map_tile" accept="image/*">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row city_image">
                                <div class="col-md-8">
                                    ...
                                    <img id="preview_banner" src="https://via.placeholder.com/200x150?text=banner" alt="city banner">
                                    <input type="file" class="form-control" id="city_banner" name="banner" accept="image/*">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="city_website">Website:</label>
                                <input type="text" class="form-control" id="city_website" name="website">
                            </div>

                            <div class="form-group">
                                <label for="city_video">Video:</label>
                                <input type="text" class="form-control" id="city_video" name="video">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="seo_title">Mark as Popular District:</label>
                                        <input type="checkbox" value="1" id="is_popular" name="is_popular">
                                    </div>
                                </div>
                            </div>
