            ...
            <ul class="nav side-menu">
                ...
                <li id="menu_place">
                    ...
                    <ul class="nav child_menu">
                        ...
                        <li><a href="{{route('admin_highlighted_product_list')}}"><i class="fa fa-shopping-bag"></i>Highlighted Products</a></li>
                        ...
                        <li><a href="{{route('admin_place_type_list')}}"><i class="fa fa-tags"></i> Sub Categories</a></li>
                        <li><a href="{{route('admin_amenities_list')}}"><i class="fa fa-wifi"></i> Amenities</a></li>
                        <li><a href="{{route('admin_city_list')}}"><i class="fa fa-building"></i> Districts</a></li>
                        <li><a href="{{route('admin_region_list')}}"><i class="fa fa-globe"></i> Regions</a></li>
                        <li><a href="{{route('admin_interest_list')}}"><i class="fa fa-globe"></i> Interests</a></li>
                    </ul>
                </li>
                ...
                <li><a href="{{route('admin_ads_banners')}}"><i class="fa fa-image"></i> Ads Banners</a></li>

                <li><a href="{{route('admin_competition_list')}}"><i class="fa fa-calendar"></i> Competitions</a></li>
                ...
                <li><a href="{{route('admin_newsletter_subscribers_list')}}"><i class="fa fa-users"></i> Newsletter Subscribers</a></li>
