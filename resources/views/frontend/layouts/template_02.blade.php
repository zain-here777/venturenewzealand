                        ...
                        @guest
                            ...
                            <div class="popup popup-form">
                                ...
                                <ul class="choose-form">
                                    <li class="nav-login exclude-class"><a title="Log In" href="#login">{{__('Log In')}}</a></li>
                                    <li class="nav-signup exclude-class"><a title="Sign Up" href="#register">Sign Up</a></li>
                                </ul>
    ...
    <footer id="footer" class="footer layout-02">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="footer__top__info">
                            <a title="Logo" href="#" class="footer__top__info__logo"><img src="{{asset(setting('logo') ? 'uploads/' . setting('logo') : 'assets/images/assets/logo.png')}}" alt="Venture New Zealand"></a>
            ...
            <div class="footer__bottom">
                <p class="footer__bottom__copyright">{{now()->year}} &copy; <a href="{{url('/')}}" target="_blank">{{__('Venture New Zealand')}}</a>. {{__('All rights reserved.')}}</p>
            </div><!-- .top-footer -->
        </div><!-- .container -->
    </footer><!-- site-footer -->
    @if(isRoute('home'))
        ...
        <div class="landing-banner business-landing-banner" {{$home_banner_app}}>
            <div class="container">
                <div class="lb-info">
                    <h2>{{__('The Venture New Zealand App')}}</h2>
