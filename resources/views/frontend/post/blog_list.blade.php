...
@section('main')
    <main id="main" class="site-main">
        <div class="site-content site-contact blog-page-content">
            <div class="page-title page-title--small page-title--blog align-left @if($blog_title_bg) background-image @endif"  {!! $blog_title_bg !!}>
                <div class="container">
