                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="2" style="padding: 0 30px 10px ; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                                        <p style="margin-top: 0; margin-bottom: 15px;font-size: 18px;font-weight: 600;">Your reservation is canceled. <a href="{{route('home')}}" style="color: #72bf45;text-decoration: none;" target="_blank">{{setting('app_name')}}</a></p>
                                    </td>
                                </tr>
                                <tr>
