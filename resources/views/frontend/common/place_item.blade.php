<div class="places-item hover__box hover_position">
    ...
    <a data-tooltip="Favourite" data-position="left" href="#" class="place-item__addwishlist @if($place->wish_list_count) remove_wishlist active @else @guest open-login @else add_wishlist @endguest @endif" data-id="{{$place->id}}" title="Add Wishlist">
