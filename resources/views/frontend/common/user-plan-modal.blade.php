            ...
            <div class="modal-body member-wrap mb-0">+
                ...
                <article class="card__content">
                    ...
                    <header class="card__header">
                        ...
                        <span
                            class="card__header-subtitle">{{App\Models\UserSubscription::getSubscriptionDaysForUserType(1)}}
                            Days</span>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="payment-form" action="{{route('stripe_charge')}}" method="post">
                ...
                <div class="modal-body member-wrap mb-0">
                    <h3>Pay with card ${{App\Models\UserSubscription::getSubscriptionPriceForUserType(1)}}</h3>
