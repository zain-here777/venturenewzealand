    ...
    Calendar.prototype = {
        ...
        trigger: function () {
            ...
            $(document).click(function (e) {
                if (_this.$trigger[0] != e.target && !$.contains($this[0], e.target)) {
                    if (e.target !== null && e.target.hasClass('calendar-wrapper loading-wrapper') == false) {
                        $this.hide();
                    }
                }
            ...
            var _this = this,
                ...
                exec = {
                    prev: function () {
                        ...
                        if (_this.options.onChangeMonth) {
                            _this.options.onChangeMonth.call(_this, _this, y, m - 1);
                        }
                    },
                    next: function () {
                        if (_this.options.onChangeMonth) {
                            _this.options.onChangeMonth.call(_this, _this, y, m);
                        }
        ...
        event: function () {
            ...
            _this.$element.on('click', '[' + ITEM_DAY + ']', function () {
                ...
                _this.options.onSelected.call(this, _this, 'date', day, $(this).data(MARK_DATA));
                ...
                vc('date', y, m);
                _this.options.onSelected.call(this, _this, 'month', new Date(y, m - 1));
            });
